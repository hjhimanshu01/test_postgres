...
INSERT INTO pricing_models (id, name)
	...
	('3f5ac0ce-4514-4edc-a926-a55dcbeee9ab', 'test for delete'),
	('86c2616a-4de3-11ea-913e-00d861092d57', 'test for check config add');
...
INSERT INTO pricing_model_price(pricing_model_id, price_id)
	...
	('3f5ac0ce-4514-4edc-a926-a55dcbeee9ab', '75f471d7-4d0f-11ea-9db2-00d861092d57'),
...
INSERT INTO machines(id, name, pricing_id)
	...
	('c3dc6c19-1087-47c4-87ac-3d2f3fcf0e05', 'machine test', NULL),
	('94415002-45fd-4a51-9ed7-827d1af502d9', 'machine test 2', '3ba92095-3203-4888-a464-3c7d5d9acd7e'),
